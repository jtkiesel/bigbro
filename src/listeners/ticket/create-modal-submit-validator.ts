...
import { messageLogger, settingsManager } from "../../index.js";
...
> {
  public override async run(interaction: Interaction) {
    ...
    const guildSettings = await settingsManager.increment(interaction.guildId, {
      lastTicketNumber: 1,
    });
    ...
    const ticketChannel =
      await interaction.client.channels.fetch(ticketChannelId);
